...
//         // Admin registration typically requires a special key
//         if (formData.admin_key !== "ADMIN_SECRET_KEY") {
//             setError("Invalid admin registration key");
//             setLoading(false);
//             return;
//         }

//         // Note: Admin registration endpoint might be different
//         setError("Admin accounts are created by system administrators only. Please contact support.");
//         setLoading(false);
//     };
...
//                     <p className="text-gray-500 mt-1">Restricted access</p>
//                 </div>
...
//                     <Link href="/authentication/admin/login" className="text-red-600 hover:underline">
...
import Link from "next/link";
import { useRouter } from "next/navigation";
import { LockClosedIcon, EnvelopeIcon, UserIcon, PhoneIcon, ShieldCheckIcon } from "@heroicons/react/24/outline";
...
export default function AdminRegister() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-red-950 to-slate-900 px-4 py-10">
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <p className="text-red-300 mt-1 text-sm">Create a merchant admin account</p>
                </div>

                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
                    {error && (
                        <div className="mb-5 bg-red-500/20 border border-red-400/50 text-red-200 px-4 py-3 rounded-xl text-sm flex items-center gap-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    value={formData.full_name}
                                    onChange={handleChange}
                                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-red-500 outline-none"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-red-600 hover:bg-red-700 text-white py-3 rounded-xl font-semibold transition flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg mt-2"
                        >
