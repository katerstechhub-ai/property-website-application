...
function ImageUploadModal({ prop, onClose, onSuccess, showToast }) {
    ...
    const uploadImages = async () => {
        ...
        try {
            ...
            showToast(`Uploading ${compressed.length} image(s)...`, "success");

            const response = await fetch(`/api/proxy/properties/${propertyId}/resource`, {
                method: "PUT",
                headers: {
            ...
            >
                <div className="p-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button onClick={onClose} className="flex-1 border border-gray-200 py-2.5 rounded-lg hover:bg-gray-50 transition">
                            Cancel
                        </button>
                    </div>
                </div>
